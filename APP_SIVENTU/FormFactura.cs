...
namespace APP_SIVENTU
{
    public partial class FormFactura : Form
    {
        ...
        private void btagregar_fac_Click(object sender, EventArgs e)
        {
            ...
            file.Cells[4].Value = (float.Parse(textBox1.Text) * float.Parse(txtcantidad.Text)).ToString();

            dgvfactu.Rows.Add(file);

            //labcodigo2.Text = labnombre2.Text = labprecio2.Text = txtcantidad.Text = combofactu.Text= "";
            obtenerTotal();
        }
        ...
        private void btguardar_fac_Click(object sender, EventArgs e)
        {
            string codigo = textBox1.Text.Trim(),
                ...
                precio = textBox3.Text.Trim(),
                cantidad = txtcantidad.Text.Trim(),
                total =textBox4.Text.Trim();
            ...
            Ticket1.TextoIzquierda(" ");
            Ticket1.AgregaTotales("Efectivo Entregado:", int.Parse(txtefectivo.Text));
        ...
        private void labprecio2_Click(object sender, EventArgs e)
        {
